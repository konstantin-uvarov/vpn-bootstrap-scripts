#!/usr/bin/env bash
#
# Outline VPN Server - Bootstrap Script
# Downloads and sets up the Outline VPN server on a fresh Linux VM
#
# Usage:
#   curl -sSL <PUBLIC_URL>/bootstrap-outline.sh | bash
#   # Or download first:
#   curl -sSL <PUBLIC_URL>/bootstrap-outline.sh -o bootstrap.sh && bash bootstrap.sh
#
...
DEFAULT_REPO="https://github.com/konstantin-uvarov/docker-outline.git"
...
main() {
    echo "" >&2
    echo "==========================================" >&2
    echo "  Outline VPN Server - Bootstrap Script" >&2
    echo "==========================================" >&2
    echo "" >&2
